...
public class NoteDialog {
    ...
    public NoteDialog(Context context, NoteModelViewModel noteModelViewModel, NoteModel noteModel, CourseModel courseModel, boolean isInserting){
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if(!Utils.isEmpty(note_title) && !Utils.isEmpty(note_body)){
                            if(isInserting){
                                ...
                                new_note.setCourse_id(courseModel.getId());
