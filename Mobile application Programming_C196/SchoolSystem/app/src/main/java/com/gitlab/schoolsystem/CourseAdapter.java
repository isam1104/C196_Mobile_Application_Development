...
public class CourseAdapter  extends RecyclerView.Adapter<CourseAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // listeners
        holder.course_instructor_view.setOnClickListener(view -> {
        ...
        holder.alarm_picker.setOnClickListener(view-> {
            int current_position = holder.getAdapterPosition();
            if(listener != null && current_position != RecyclerView.NO_POSITION)
            {
                listener.onAlarmPickerClicked(courseModelList.get(current_position));
            }
        });
    }
    ...
    public void setTermModel(TermModel termModel){ this.termModel = termModel; }
    public  class  ViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageButton delete_btn, alarm_picker;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            alarm_picker = itemView.findViewById(R.id.course_set_alarm);
    ...
    public interface OnCourseListener{
        ...
        void onAlarmPickerClicked(CourseModel course);
    }
